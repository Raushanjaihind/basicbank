...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">
        ...
        <img src="images/my_logo.png" alt="logo" style="width:150px;">
      </a>
  ...
  <section class="topContent">
    <div class="mainHeading">
      ...
      <a href="#services" class="btn btn-outline-primary my-2 my-sm-0 mt-3">Let's Go...</a>
    </div>
    <div class="topContentImg">
      <img src="images/download2.png" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="images/bank3.jfif" alt="RSF Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          ...
          <a href="#services" class="btn btn-outline-primary my-2 my-sm-0 mt-3">Learn More</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/123.jfif" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="images/transation.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
